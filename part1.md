...
||6.1.2490||XOR||"x-or"||CORE||( x1 x2 -- x3 )||
...
||6.2.0260||0<>||"zero-not-equals"||CORE EXT||( x -- flag )||
flag is true if and only if x is not equal to zero. 
||6.2.0280||0>||"zero-greater"||CORE EXT||( n -- flag )||
...
||6.2.1485||FALSE||"xxxxx"||CORE EXT||( -- false )||
Return a false flag. 
|See:| **3.1.3.1 Flags**
...
||6.2.1930||NIP||"xxxxx"||CORE EXT||( x1 x2 -- x2 )||
...
||6.2.2008||PARSE||"xxxxx"||CORE EXT||( char "ccc&lt;char>" -- c-addr u )||
...
||6.2.2030||PICK||"xxxxx"||CORE EXT||( xu ... x1 x0 u -- xu ... x1 x0 xu )||
...
Note: This word is obsolescent and is included as a concession to existing implementations.
||6.2.2125||REFILL||"xxxxx"||CORE EXT||( -- flag )||
...
||6.2.2148||RESTORE-INPUT||"xxxxx"||CORE EXT||( xn ... x1 n -- flag )||
...
||6.2.2150||ROLL||"xxxxx"||CORE EXT||( xu xu-1 ... x0 u -- xu-1 ... x0 xu )||
...
||6.2.2298||TRUE||"xxxxx"||CORE EXT||( -- true )||
Return a true flag, a single-cell value with all bits set. 
|See:| **3.1.3.1 Flags**. 
||6.2.2300||TUCK||"xxxxx"||CORE EXT||( x1 x2 -- x2 x1 x2 )||
Copy the first (top) stack item below the second stack item. 
||6.2.2330||U.R||"u-dot-r"||CORE EXT||( u n -- )||
...
||6.2.2350||U>||"u-greater-than"||CORE EXT||( u1 u2 -- flag )||
flag is true if and only if u1 is greater than u2. 
|See:| **6.1.0540 >**. 
||6.2.2395||UNUSED||"xxxxx"||CORE EXT||( -- u )||
